...
@section('content')
    @if(!empty($filter))
        <div class='card'>
            <div class='card-header'>
                <div class='float-left'>{{ __('user::message.Filter Role') }}</div>
    ...
    <div class='card'>
        <div class='card-header'>
            <div class='float-left'>{{ __('user::message.Role Report') }}</div>
            @empty(!$linkRegister)
                <div class='float-right'><a href="{{ $linkRegister }}"
                                            class='btn btn-light'>{{__('user::message.New Register')}}</a></div>
            @endif
        </div>
